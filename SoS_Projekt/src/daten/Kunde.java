...
public class Kunde {
	...
	/**
	 * 
	 * @return ID des n�chsten Kunden das erstellt wird
	 */
	...
	/**Pr�ft ob der Kunde ein neuer Kunde ist und speichert ihn ab Validierung ab
	 * @param neuerKunde
	 * 
	 */
	...
	/**
	 * verweist auf Methode in DBKunde.java um den Kunden zu l�schen
	 * 
	 * @param kundenummer
	 * @throws SQLException
	...
	/**
	 * Setzt eine Email f�r den Kunden fest
	 * @param email
	 */
	...
	/**
	 * Setzt eine Telefonnummer f�r den Kunden fest
	 * @param telefon
	 */
	...
	/**
	 * Setzt eine Adresse f�r den Kunden fest
	 * @param adresse
	 */
	...
	/**
	 * Setzt eine Bezahlmethode f�r den Kunden fest
	 * @param bezahlmethode
	 */
	...
	/**
	 * Setzt eine Name f�r den Kunden fest
	 * @param name
	 */
	...
	/**
	 * Setzt eine Kundennumer f�r den n�chsten Kunden fest
	...
	/**
	 * Kundennummer wird hier hochgez�hlt und in die DatenBank hochgeladen
	 * @param kennzahl
	 * @return kundenummer
	 */
